...
- [Scale Adaptive System](../scale-adaptive-system/index.md) - Understanding project levels
- [Brownfield Guide](../brownfield-guide/index.md) - Working with existing code

**Other Guides:**

- [Enterprise Agentic Development](../enterprise-agentic-development/index.md) - Team collaboration
