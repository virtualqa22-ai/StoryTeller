...
// Step 6: Review and Create data structure
export interface WizardStep6Data {
	// This step doesn't collect new data, it just reviews all previous data
	// All data is already stored in the wizard state from previous steps
}
